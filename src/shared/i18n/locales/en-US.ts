...
export const enUS = {
  ...
  lessonPlans: {
    errors: {
      ...
      invalidTeacherId: 'Teacher id is required',
      invalidObjectives: 'At least one learning objective is required',
      invalidContent: 'Lesson content is required',
      invalidMethodology: 'Methodology is required',
      invalidSchedule: 'At least one schedule step is required',
      invalidAssessment: 'Assessment is required',
      invalidResources: 'At least one resource is required',
