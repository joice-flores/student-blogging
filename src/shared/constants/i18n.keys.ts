...
export const LESSON_PLANS = {
  ERRORS: {
    ...
    INVALID_TEACHER_ID: 'lessonPlans.errors.invalidTeacherId',
    INVALID_OBJECTIVES: 'lessonPlans.errors.invalidObjectives',
    INVALID_CONTENT: 'lessonPlans.errors.invalidContent',
    INVALID_METHODOLOGY: 'lessonPlans.errors.invalidMethodology',
    INVALID_SCHEDULE: 'lessonPlans.errors.invalidSchedule',
    INVALID_ASSESSMENT: 'lessonPlans.errors.invalidAssessment',
    INVALID_RESOURCES: 'lessonPlans.errors.invalidResources',
